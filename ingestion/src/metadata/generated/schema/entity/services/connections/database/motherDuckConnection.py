...
#   filename:  entity/services/connections/database/motherDuckConnection.json
#   timestamp: 2026-04-24T07:49:39+00:00
...
class MotherDuckConnection(BaseModel):
    ...
    type: Annotated[
        Optional[MotherDuckType],
        Field(
            MotherDuckType.MotherDuck, description='Service Type', title='Service Type'
        ),
    ]
    scheme: Annotated[
    ...
    token: Annotated[
        CustomSecretStr,
        Field(
            description='MotherDuck Service Token to authenticate with the service.',
